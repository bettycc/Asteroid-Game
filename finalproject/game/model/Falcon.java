...
public class Falcon extends Sprite {
	...
	public Falcon() {
        ...
        //put falcon int the middle at bottom
        setCenter(new Point(Game.DIM.width / 2, (Game.DIM.height / 10) * 9));
		
		//with random orientation
		//setOrientation(Game.R.nextInt(360));
        //with random orientation -90,一開始指向正上方。
        setOrientation(-90);
    ...
    public void setShield(boolean bShield) {
...
/**
    public void drawShieldWithColor(Graphics g) {
        ...
        if (bShield && nShield > 0) {
            ...
            g.setColor(Color.cyan);
            g.drawOval(getCenter().x - getRadius(),
                    getCenter().y - getRadius(), getRadius(),
                    getRadius());
...
//	public int getShield() {return nShield;}
    public boolean isbShield(){return bShield;}
